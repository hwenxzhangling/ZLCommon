...
+ (void)load {
    ...
    Method origMethod2 = class_getInstanceMethod([self class], NSSelectorFromString(@"dealloc"));
    Method newMethod2 = class_getInstanceMethod([self class], @selector(jk_textView_placeholder_swizzledDealloc));
